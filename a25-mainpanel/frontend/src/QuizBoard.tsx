...
import { Box, Grid, GridItem, Flex, VStack, Stack, HStack } from "@chakra-ui/react";
...
export default function QuizBoard() {
  ...
  return (
    <>
      ...
      <Flex direction={"column"} h={"100dvh"} color={"blackAlpha.700"} fontWeight={"bold"} bg={"orange.50"}>
        <Stack fontSize={35} w={"100%"} h={"8%"}>
      ...
      {/* <Grid
        ...
        bg={"orange.50"}
      >
        <GridItem area={"header"} fontSize={35}>
          <SideScroll finalFlag={finalFlag} onKeydownAttack={onKeydownAttack} />
        </GridItem>

        <GridItem area={"leftSideNav"} borderRight={"2px"} borderColor={"orange.100"}>
          <PlayerScoreBoard colorCounts={colorCounts} color={color} finalQuizData={finalQuizData} />
        </GridItem>
